...
def check_haarcascadefile():
    exists = os.path.isfile("Face_recognition_based_attendance_system-master\haarcascade_frontalface_default.xml")
    if exists:
        pass
    else:
...
def TakeImages():
    ...
    if ((name.isalpha()) or (' ' in name)):
        ...
        harcascadePath = "Face_recognition_based_attendance_system-master\haarcascade_frontalface_default.xml"
